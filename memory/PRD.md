...
- **Maps**: HERE logistics.satellite.day tiles (55° tilt, vehicle_restrictions overlay, ppi=400) + Mapbox satellite-streets-v12 (SAT 2D)
...
- [x] Vehicle restrictions overlay (no-truck zones, weight limits, height barriers) via HERE features param — Apr 9, 2026
...
- [x] Nginx proxy config (port 3000 → 8001) for Emergent platform routing
