          ...
          {mode === 'main' && (
            <>
              ...
              <button
                ...
                disabled={isSubmitting}
                className="w-full py-3.5 bg-white text-black font-bold rounded-2xl transition-all flex items-center justify-center gap-3 hover:bg-zinc-100 disabled:opacity-50"
              >
